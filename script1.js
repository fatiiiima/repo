...
questionElement.innerHTML="Look around carefully and search for clues to begin your adventure.🔍<br><br> ---Check the PHONE on the desk ---<br>The game starts with a quiz. Pay attention and good luck! <br><br> To LEAVE the game, you can use the door on the right 🚪🚶‍♂️.";
...
Bbutton.addEventListener("click", () => {
    if(OKbutton){
        ...
        questionElement.innerHTML = "Hello there! <br> To begin your quest 🔍, simply tap on the PC screen.<br><br>Remember, you can only answer each question once.Your score determines the amount of money you can use to buy things, so choose wisely. Good luck and enjoy the challenge!";
        nextButton.innerHTML = "OK";
    }
});

document.getElementById("door").addEventListener("click", function() {
    window.location.href = "loguser.php";
});
